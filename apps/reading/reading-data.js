...
const READING_LETTERS = {
  ...
  'ה': { name: 'הֵא', letterAudio: 'hei_1.mp3', words: [
    ...
    { word: 'הֶלִיקוֹפְּטֶר', emoji: '🚁', audio: '' },
  ]},
...
// לכל משפט יש נוסח נקבה (f) וזכר (m). neutral=true → זהה לשני המגדרים
// (אפשר להשמיע הקלטה של המשפחה לכל ילד/ה). משפטים מגדריים מוקלטים בקול
// המשפחה (נקבה) — לבנים יושמע הנוסח בזכר בקול סינתטי.
const READING_PHRASES = [
  { key: 'perfect',   f: 'מושלם!',           m: 'מושלם!',           neutral: true },
  { key: 'great',     f: 'כל הכבוד!',        m: 'כל הכבוד!',        neutral: true },
  { key: 'done',      f: 'יופי, סיימת!',     m: 'יופי, סיימת!',     neutral: true },
  { key: 'excellent', f: 'מצוין!',           m: 'מצוין!',           neutral: true },
  { key: 'wow',       f: 'וואו, איזה יופי!', m: 'וואו, איזה יופי!', neutral: true },
  { key: 'nice',      f: 'עבודה יפה!',       m: 'עבודה יפה!',       neutral: true },
  { key: 'champ',     f: 'את אלופה!',        m: 'אתה אלוף!' },
  { key: 'go',        f: 'קדימה, את יכולה!', m: 'קדימה, אתה יכול!' },
];
...
function buildReadingStations() {
  ...
  stations.push({ id: 'final_quiz', type: 'quiz', mixed: true, isBoss: true, groupId: F, groupName: FN,
    title: 'מסע האוצרות הגדול', emoji: '👑', letters: ALL.slice() });
